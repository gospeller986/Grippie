    ...
    return (
        <div className='w-full '>
            ...
            >
                ...
                <div className="w-full md:w-[420px] md:px-0 px-[18px] h-[290px] mt-[40px] md:mt-0 relative"
                ...
                >
                    ...
                    <button className='w-full' onClick={handleRedirectToGallery}>
                        <Image
                            ...
                            style={{
                                boxShadow: "0px 4px 20px rgba(57, 47, 75, 1)"
                            }}
                        />
                    </button>
                ...
                <div className='mt-[32px]   px-[36px] md:w-[420px] md:px-0 z-10'>
