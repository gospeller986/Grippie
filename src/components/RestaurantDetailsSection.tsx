...
const RestaurantDetailsSection = () => {
    ...
    return (
        <>
            ...
            <p className='mt-[16px] md:mt-[22px]' style={{ paddingLeft: "18px", paddingRight: "18px", marginTop: '16px', fontWeight: "600" , fontFamily : 'ProximaNovaL' }}>
                <span style={{ color: "#8CBB41" }}>OPEN</span>
                <span style={{ color: "#5A5A5A" }}> ·   12PM - 1AM   |   Qutub Institutional Area </span>
            </p>
            <button
                onClick={handleRequestReservation}
                className="w-full mt-[36px] h-[60px] rounded-[14px] hover:shadow-md"
                style={{
